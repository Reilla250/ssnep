...
const Store = {
  ...
  DEFAULTS: {
    ...
    team: [
      {id:1,name:'Alice Okuo Amadra',role:'Program Officer',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'AO',color:'#37474F',status:'active',photoUrl:'assets/images/team-member-1.jpeg'},
      {id:2,name:'Lole Laila Lole',role:'Executive Director',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'LL',color:'#1565C0',status:'active',photoUrl:'assets/images/team-member-2.jpeg'},
      {id:3,name:'Samuel Bullen',role:'Finance Administrator',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'SB',color:'#2E7D32',status:'active',photoUrl:'assets/images/team-member-3.jpeg'},
      {id:4,name:'Wani Isaac',role:'Clinical Project Officer',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'WI',color:'#4A148C',status:'active',photoUrl:'assets/images/team-member-4.jpeg'},
      {id:5,name:'Kiden Sarah',role:'Finance Assistant',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'KS',color:'#B71C1C',status:'active',photoUrl:'assets/images/team-member-5.jpeg'},
      {id:6,name:'Koma Williams',role:'Clinical Project Nurse',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'KW',color:'#E65100',status:'active',photoUrl:'assets/images/team-member-7.jpeg'},
      {id:7,name:'Poni Rose',role:'HIV Advocacy and Prevention Officer',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'PR',color:'#00695C',status:'active',photoUrl:'assets/images/team-member-9.jpeg'},
      {id:8,name:'Obulejo Jackson',role:'M&E Officer',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'OJ',color:'#283593',status:'active',photoUrl:'assets/images/team-member-18.png'},
      {id:9,name:'Likambo Moses John',role:'SBCC Officer',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'LM',color:'#558B2F',status:'active',photoUrl:'assets/images/team-member-19.jpeg'},
      {id:10,name:'Joseph Oniku Karlino',role:'SBCC Officer',email:'',phone:'',bio:'',facebook:'',twitter:'',linkedin:'',initials:'JO',color:'#1565C0',status:'active',photoUrl:'assets/images/team-member-22.jpeg'},
    ],
    news: [
      ...
      {id:5,title:'Capacity Building for PLHIV Member Associations Completed',category:'Capacity Building',date:'2024-04-05',status:'draft',excerpt:'Comprehensive capacity building program for PLHIV member associations completed.',imageUrl:'assets/images/news-5.jpg'},
    ],
    programs: [
      {id:1,title:'Malaria Programs',icon:'🦟',status:'active',description:'Malaria is a serious threat in South Sudan. We focus on prevention, quick diagnosis, and proper treatment.',imageUrl:'assets/images/service-1.png'},
      {id:2,title:'HIV/AIDS Awareness',icon:'🎗️',status:'active',description:'With awareness and access to resources, we can make a difference in the fight against HIV/AIDS.',imageUrl:'assets/images/service-2.jpeg'},
      {id:3,title:'Tuberculosis',icon:'🩺',status:'active',description:'SSNeP plays a crucial role in addressing the dual burden of HIV and Tuberculosis in South Sudan.',imageUrl:'assets/images/service-3.jpg'},
      {id:4,title:'Monitoring & Evaluation',icon:'📊',status:'active',description:'SSNeP+ has developed key quality assurance mechanisms for HIV prevention, treatment, care, and retention.',imageUrl:'assets/images/service-5.jpg'},
      {id:5,title:'Reporting',icon:'📋',status:'active',description:'SSNeP uses different reporting approaches with key consideration on donor requirements and National Strategic Plan.',imageUrl:'assets/images/service-6.jpg'},
